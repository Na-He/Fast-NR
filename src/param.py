...
def defOpt () :
    ...
    required.add_argument("-c", '--control', type=str, required=True, help="Control file path and name, usually the STARR-seq plasmid library. Only .bam and .bed file accpected.")
    required.add_argument("-t", '--treatment', type=str, required=True, help="Treatment file path and name, usually the STARR-seq cDNA library. Only .bam and 3 column or 6 column .bed file accpected. But this program will not consider the strand information.")
